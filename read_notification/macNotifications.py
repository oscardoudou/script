...
# Modified by  : oscardoudou
# Why using    : bridge the gap between 
#                being able migrate latest notification to main database and 
#                send the necessary content to a mac app
# Note         : OS X 10.14.6 - Mojave may support as well
        ...
        try:
            ...
            with codecs.open(outputPath, 'w', encoding='utf-16') as csv:
                ...
                try:
                    ...
                    # notion
                    startIndex = last.index(":")+2
                    endIndex = last.index("(")-1
                    print (last[startIndex:endIndex])
                    # todo imessage
                    # print (last)
                except Exception as ex:
